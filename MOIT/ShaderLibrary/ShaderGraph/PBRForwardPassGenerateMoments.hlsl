...
*/
    ...
    //return GenerateMoments(positionCSZ, 1 - color.a);
    //return GenerateMoments(positionCSZ, 1 - saturate(color.a));
    return GenerateMoments(positionCSZ, 1 - surfaceDescription.Alpha);
    //return GenerateMoments(positionCSZ, 1 - saturate(surfaceDescription.Alpha));
    //return GenerateMoments(positionCSZ, 1 - surface.alpha);

    //return GenerateMoments(positionCSZ, 1 - saturate(color.a));
    //return GenerateMoments(positionCSZ, max(0.99, 1.0 - saturate(color.a)));
}