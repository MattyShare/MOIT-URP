...
)
{
    ...
    */
    ...
    //return GenerateMoments(positionCSZ, 1 - saturate(alpha));
    ...
    //return GenerateMoments(positionCSZ, 1 - finalColor.a);
    //return GenerateMoments(positionCSZ, 1 - saturate(finalColor.a));
}